...
![img](fin_tienluong_nhanvien04.png)

***Bước 2:***

- Tại đây, người dùng bấm "Tải biểu mẫu danh sách nhân viên" để tải xuống file mẫu nhập dữ liệu 

  ![](fin_tienluong_nhanvien05.png)

- Người dùng nhập dữ liệu thông tin nhân viên vào file excel.

  ![](fin_tienluong_nhanvien06.png)

***Bước 3:*** Trên giao diện phần mềm, người dùng bấm nút ![](fin_tienluong_naptaptin_btn.png) >> hệ thống hiển thị màn hình như sau ![](fin_tienluong_nhanvien07.png)

 Tại đây người dùng kiểm tra thông tin dữ liệu, và bấm nút ![](fin_tienluong_kiemthu_btn.png)để hệ thống kiểm tra dữ liệu trước khi nhập >> Hệ thống tự động kiểm tra và thông báo kết quả lỗi dữ liệu lên màn hình >> Người dùng đọc thông báo và điều chỉnh dữ liệu trên file excel để chính xác, sau đó bấm ![](fin_tienluong_naptaptin_btn.png)) để tải lại file sau khi chỉnh sửa dữ liệu >> Tiếp tục bấm **Kiểm thử** để kiểm tra cho đến khi kết quả hệ thống kiểm tra thông báo là ![](fin_tienluong_tbaohople.png)

***Bước 4:*** Người dùng bấm nút ![](fin_tienluong_nhap_btn.png) để thực hiện nạp dữ liệu vào hệ thống >> Hệ thống ghi nhận dữ liệu và hiển thị thông báo Thêm bản ghi thành công.
...
![img](fin_tienluong_nhanvien01.png)

***Bước 2:*** Vào mục Yêu thích > Chọn mục **Import dữ liệu thông tin nhân viên**

![img](fin_tienluong_nhanvien12.png)

***Bước 3***: Hoàn thành thông tin cần nhập liệu

- *Tải file mẫu:* Người dùng thực hiện tải file mẫu bằng cách bấm vào dòng chữ "Mẫu nhập cho thông tin nhân viên"![](fin_tienluong_nhanvien13.png)
...
![](fin_tienluong_nhanvien14.png)

***Bước 4:*** Trên màn hình hệ thống, nhấn vào Nạp tập tin ![](fin_tienluong_naptaptin_btn.png) và tải lên tập tin vừa lưu
...
- Lựa chọn trang dữ liệu cần import: Biểu mẫu tải về chứa nhiều trang thông tin, người dùng có thể nhập một trong các trang dữ liệu đó và chọn đúng trang tính cần nhập dữ liệu để tải lên
  ...
  ![](![](fin_tienluong_nhanvien15.png.png)

- Kiểm tra việc gắn dữ liệu theo cột trên file excel với các cột dữ liệu trên hệ thống

- Sau đó, bấm nút ![](fin_tienluong_kiemthu_btn.png) để hệ thống kiểm tra dữ liệu trước khi nhập >> Hệ thống tự động kiểm tra và thông báo kết quả lỗi dữ liệu lên màn hình >> Người dùng đọc thông báo và điều chỉnh dữ liệu trên file excel để chính xác, sau đó bấm ![](fin_tienluong_naptaptin_btn.png) để tải lại file sau khi chỉnh sửa dữ liệu >> Tiếp tục bấm **Kiểm thử** để kiểm tra cho đến khi kết quả hệ thống kiểm tra thông báo là ![](fin_tienluong_tbaohople_btn.png)

- Người dùng bấm vào nút ![](fin_tienluong_nhap_btn.png) để tải lên dữ liệu. Hệ thống sẽ hiển thị thông báo Thêm bản ghi thành công sau khi hoàn tất nạp dữ liệu.
...
![](fin_tienluong_loaidangkycong.png)
...
![](fin_tienluong_loaidangkycong01.png)
...
![](fin_tienluong_tonghopcong01.png)
...
![](fin_tienluong_tonghopcong02.png)
...
![](fin_tienluong_tonghopcong05.png)
...
![](fin_tienluong_tonghopcong06.png)
...
![](fin_tienluong_tonghopcong07.png)
...
2. ***"Thời gian làm việc không hợp lệ"***
   ...
   - Xử lý: Kiểm tra lại dữ liệu chấm công theo dòng và cột, đảm bảo đúng ký hiệu công, đúng quy tắc. Tiếp đến kiểm tra thêm tổng số giờ công làm việc (Bao gồm loại công Nghỉ có lương & Nghỉ không lương & Chấm công) và số giờ làm việc chuẩn trên lịch làm việc của nhân việc.
     ...
     ![](fin_tienluong_tonghopcong08.png)

     ![](fin_tienluong_tonghopcong09.png)
...
![](fin_tienluong_thietlapphanca.png)
...
![](fin_tienluong_thieplapkyhieucong01.png)

***Bước 2:*** Nhập tên công, mã công, loại công > Nhấn **Lưu**

![](fin_tienluong_thieplapkyhieucong02.png)
...
![](fin_tienluong_thietlapcalamviec01.png)

***Bước 2:*** Điền đầy đủ thông tin vào các trường bắt buộc > Nhấn **Lưu**

![](fin_tienluong_thietlapcalamviec02.png)
...
![](fin_tienluong_thietlapcalamviec03.png)
...
![](fin_tienluong_thietlapcalamviec04.png)

- Thiết lập ca làm việc với tên: ***Ca 3\***, mã: ***TC3\***, kí hiệu: ***TC3\***

![](fin_tienluong_thietlapcalamviec05.png)
...
![](fin_tienluong_phancachitiet03.png)
...
![](fin_tienluong_phancachitiet04.png)
...
Bấm nút **Duyệt** ![](fin_tienluong_duyet_btn.png) để duyệt Chi tiết phân ca. Chi tiết phân ca sau khi được duyệt sẽ xuất hiện tại Bảng tổng hợp phân ca.
...
![](fin_tienluong_denghidoica01.png)

*Bước 2:* Điền thông tin vào các trường bắt buộc

![](fin_tienluong_denghidoica02.png)
...
- Người dùng chấp thuận đề nghị đổi ca thì nhấn **Duyệt**, bản ghi chuyển về trạng thái Duyệt. Tại Bảng tổng hợp phân ca, ca của hai nhân viên đó sẽ được thay đổi cho nhau
  ...
  ![](fin_tienluong_denghidoica03.png)
...
- Ngược lại, người dùng nhấn **Từ chối**, bản ghi chuyển về trạng thái Từ chối. Không có sự thay đổi nào ở Bảng tổng hợp phân ca. Người duyệt có thể chuyển bản ghi về trạng thái Nháp bằng cách nhấn vào **Chuyển về Nháp** để người đề nghị đổi ca có thể chỉnh sửa.
  ...
  ![](fin_tienluong_denghidoica04.png)
...
![](fin_tienluong_tonghopphanca.jpg)
...
![](fin_tienluong_dangkycong01.png)
...
![](fin_tienluong_dangkycong02.png)
...
![](fin_tienluong_dangkyphanbo01.png)
...
![](fin_tienluong_dangkyphanbo02.png)
...
![img](fin_tienluong_bangluong03.jpg)
...
![img](fin_tienluong_bangluong06.jpg)
...
![img](fin_tienluong_bangluong07.jpg)

![img](fin_tienluong_bangluong08.jpg)

![img](fin_tienluong_bangluong09.jpg)
...
![img](fin_tienluong_bangluong10.jpg)
...
![img](fin_tienluong_bangluong11.jpg)

- Click “Bút toán”, sẽ chuyển sang màn hình Bút toán sinh ra.

![img](fin_tienluong_bangluong12.jpg)

![img](fin_tienluong_bangluong13.jpg)
...
![img](fin_tienluong_bangluong15.jpg)

***Bước 4:*** Chọn “**Ghi nhận thanh toán**”, hiển thị ra popup thanh toán

![img](fin_tienluong_bangluong16.jpg)
...
![img](fin_tienluong_bangluong17.jpg)
...
![img](fin_tienluong_bangluong18.jpg)
